...
export const NavMenu = () => {
  ...
  return (
<header
    className="flex justify-between relative pt-10 px-6 pb-6 font-bold font-sans text-white">
    <svg xmlns="http://www.w3.org/2000/svg" width="7.5625rem" height="2.0625rem">
    ...
    <nav role="navigation">
      <div ref={nav} aria-hidden={!isOpen} className="max-w-[28.5rem] sm:left-[calc(50vw-14.25rem)] absolute w-[calc(100%-3rem)] left-6 top-24 bg-callToActionBg z-10 rounded hidden"
           id="navMenu" 
    >
            <ul className="px-6 pt-10 pb-[1.9375rem] flex flex-col gap-[1.875rem]">
                ...
                <li className="text-center"><a href="">Resources</a></li>
            </ul>
            <ul
        ...
        <button onClick={handleClick} id='navBtn' aria-label="mobile navigation menu" aria-expanded={isOpen}>
            <svg
                className='hamburger'
                ...
                height="1.3125rem"
            >
                <line className='line__start' x1="0" y1="3" x2="24" y2="3" strokeWidth="3"></line>
                <line className='line__middle' x1="0" y1="11.5" x2="24" y2="11.5" strokeWidth="3"
                ></line>
                <line className='line__end' x1="0" y1="20" x2="24" y2="20" strokeWidth="3"></line>
            </svg>
        </button>
    </nav>
</header> );    
